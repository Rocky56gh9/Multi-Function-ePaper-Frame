...
echo "Initial Setup Complete. Please run the configuration scripts. Copy and paste the following into the terminal: chmod +x multimode-epaper-frame/run_all_configs.py && ./multimode-epaper-frame/run_all_configs.py
